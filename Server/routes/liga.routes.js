...
const ligaStart = require('../controllers/restart');


//////////////////////////////////////////////////////////////////////////
//Routers SQL Administrador
router.get('/sqladm/:sql', liga.getSQL);


//////////////////////////////////////////////////////////////////////////
//Routers Parametro
router.get('/parametro/:par', liga.getParametro);
...
router.get('/divisionalcam', liga.getDivisionalesCam);
...
router.get('/equipocancamtotal/:cam', liga.getcanequiposcamtotal);//Consulta datos y puntos de equipos de un campeonato
router.get('/equipocancamtotalcla/:cam', liga.getcanequiposcamtotalCLA);//Consulta datos y puntos de equipos del campeonato CLASIFICATORIO
...
router.post('/jugador', liga.createjugador); //Ingreso jugador

router.put('/jugador/:id', liga.editjugador); //Edito jugador

router.put('/jugadorsus/:ju', liga.editjugadorsus); //Edito estado jugador
router.put('/jugadorhab/:ju', liga.editjugadorhab); //Edito estado jugador
...
router.get('/partidosfeccam/:cam/:nom', liga.getpartidosfeccam); //Consulta las fechas de un campeonato, en la tabla partidos
router.get('/partidosfec/:cam/:fec', liga.getpartidosfec); //Consulta las fechas de un partido por campeonato anual
router.get('/partidosfeccla/:cam/:fec', liga.getpartidosfecCla); //Consulta las fechas de un partido por campeonato clasificatorio
...
router.get('/partidosnomfec/:nom', liga.getpartidosNomFec); //Consulta datos de partidos de los campeonatos CLASIFICATORIOS
router.get('/partidosnomfeccla/:camppal/:cam', liga.getpartidosNomFecCla); //Consulta nombre de las fechas de los campeonatos CLASIFICATORIOS

router.post('/partidos', liga.createpartido);
router.post('/partidosfot', liga.createpartidofot);

router.put('/partidos/:id', liga.editpartido); //Edito partido
...
router.get('/jugpar/:par/:eq', liga.getjugpars);//Consulta los datos de un jugador en un partido
