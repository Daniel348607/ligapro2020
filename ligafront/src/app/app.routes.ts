...
import { ClasificatorioopcComponent } from './components/clasificatorioopc/clasificatorioopc.component';
import { TorneosopcComponent } from './components/torneosopc/torneosopc.component';
import { ClasificatoriogruComponent } from './components/clasificatoriogru/clasificatoriogru.component';
import { ClasificatorioparComponent } from './components/clasificatoriopar/clasificatoriopar.component';
import { LlaveoctComponent } from './components/llaveoct/llaveoct.component';
...
const ROUTES: Routes = [
    ...
    {path: 'fixture/:cam/:fec/:nom', component: FixtureComponent},
    ...
    {path: 'clasificatorioopc', component: ClasificatorioopcComponent},
    {path: 'torneosopc', component: TorneosopcComponent},
    {path: 'clasificatoriogru', component: ClasificatoriogruComponent},
    {path: 'clasificatoriopar/:fec', component: ClasificatorioparComponent},
    {path: 'llaveoct', component: LlaveoctComponent},
